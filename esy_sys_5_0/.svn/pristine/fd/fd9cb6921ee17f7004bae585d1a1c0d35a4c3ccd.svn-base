...
public class PQuery {
	 ...
	 * @return
	 */
	public PQuery append(String hql) {
	 ...
	 * @return
	 */
	public PQuery appendGroup(String hql) {
	 ...
	 * @return
	 */
	public PQuery appendSelect(String hql) {
	 ...
	 * @return
	 */
	public PQuery appendJoin(String sql) {
	 ...
	 * @return
	 */
	public PQuery appendWhere(String hql) {
	 ...
	 */
	public PQuery setParam(String name, Object value) {
		getParams().add(name);
		getValues().add(value);
		return this;
	}
	 ...
	 */
	public PQuery setParams(Map<String, Object> paramMap) {
	 ...
	 */
	public PQuery setParamList(String name, Collection<Object> vals) {
	 ...
	 */
	public PQuery setParamList(String name, Object[] vals) {
	...
	public <T> Map<String, Object> getNativeformap(Class<T> destinationClass) {
		...
		try {
			...
			setParamsToSQLQuery(query);
			query.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP);

			List<Map<String, Object>> ret = query.list();
	 ...
	 * @param query
	 */
	public SQLQuery setParamsToSQLQuery(SQLQuery query) {
